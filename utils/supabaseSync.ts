...
export const COLLECTION_TO_TABLE: Record<string, TableSpec> = {
  ...
  staffingPlans: { table: 'staffing_plans', mode: 'HYBRID' },
  staffingQuotas: { table: 'staffing_quotas', mode: 'HYBRID' },
  staffingClasses: { table: 'staffing_classes', mode: 'HYBRID' },
  staffingAssignments: { table: 'staffing_assignments', mode: 'HYBRID' },
