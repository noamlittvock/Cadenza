"use strict";
/**
 * generatePayslip — Cloud Function callable (stub)
 *
...
exports.generatePayslip = functions.https.onCall(async (_data, _context) => {
    throw new functions.https.HttpsError("unimplemented", "generatePayslip is not yet implemented. Available in Phase 6.");
});
//# sourceMappingURL=generatePayslip.js.map