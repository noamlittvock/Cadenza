...
import { Download, Filter, Calendar as CalIcon, Check, ChevronDown } from 'lucide-react';
...
export const FinancialDashboard: React.FC<Props> = ({ events, teachers, settings }) => {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex flex-wrap gap-2 items-center">
            ...
            <button 
                ...
                className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center shadow-sm text-sm"
            >
